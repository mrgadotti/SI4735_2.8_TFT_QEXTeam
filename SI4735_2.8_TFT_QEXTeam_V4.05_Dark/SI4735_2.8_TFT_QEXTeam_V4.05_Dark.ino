//  V4.05 Dark     22-09-2022 QEX Team MOD full rebuilding design and functionaly ( BRAZIL PY Bands) Thanks QEX Team 73!
...
void setup() {
  ...
  Serial.println("Version 4.05 Dark 22/09/2022");
...
void subrstatus() {
  ...
  tft.setCursor(0, 0);
  tft.setTextColor(TFT_YELLOW, TFT_BLACK);
  tft.drawString("Software V4.05 Dark 22/09/2022 QEX Team MOD", 5, 0);
