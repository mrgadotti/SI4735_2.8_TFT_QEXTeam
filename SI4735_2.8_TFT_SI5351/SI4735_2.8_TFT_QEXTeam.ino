...
RetroBand bandRetro[] {
  ...
  "MW",   "СВ",   "",             "",                150, 80,   240, 90,    2,    520,   1710,    740,    1,  100,  1,    1,
...
void setup() {
  ...
  Serial.println("Version 4.04 15/07/2022");
  ...
  tft.setCursor(7, 70);
  tft.println(" Version 4.04");
  tft.setCursor(7, 95);
  tft.println(" 15/07/2022");
...
void subrstatus() {
  ...
  tft.setCursor(0, 0);
  tft.setTextColor(TFT_YELLOW, TFT_BLACK);
  tft.drawString("Software V4.04 15/07/2022 QEX Team MOD", 5, 0);
