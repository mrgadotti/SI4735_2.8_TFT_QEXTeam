//  V4.05          22-09-2022 QEX Team MOD full rebuilding design and functionaly ( BRAZIL PY Bands) Thanks QEX Team 73!
//  V-Lyle Hancock 17-09-2022 Added a squelch function By Lyle Hancock. Replaced the "CHIP" button with "SQLCH"
...
RetroBand bandRetro[] {
  ...
  "LW",   "OL",   "",             "",                150, 40,   240, 40,    1,    150,    375,    183,   10,   10,  1,    1,
  "MW",   "OM",   "",             "",                150, 80,   240, 90,    2,    520,   1710,    740,    1,  100,  1,    1,
  "SW1",  "OC1",  "NIGHT WINTER", "INVERNO NOITE",    10,120,     0, 40,   29,   1800,   5060,   2300,    1,  100,  5,    1,
  "SW2",  "OC2",  "NIGHT",        "NOITE",            10,160,     0, 80,   29,   5300,   7600,   5900,    1,  100,  5,    1,
  "SW3",  "OC3",  "MOSTLY NIGHT", "TODA NOITE",       10,200,     0,120,   29,   9400,  12160,   9400,    1,  100,  5,    1,
  "SW4",  "OC4",  "MOSTLY DAY",   "TODO DIA",         10,240,     0,160,   29,  13570,  18168,  13570,    1,  100,  5,    1,
  "SW5",  "OC5",  "DAY",          "DIA",              10,280,     0,200,   29,  18900,  26100,  18900,    1,  100,  5,    1,
  };
...
Band band[] = {
  ...
  {  "40M", SW_BAND_TYPE, LSB,  6900,  7300,  7120,  1, 0, 0}, // Ham   40M   12
...
void setup() {
  ...
  Serial.println("Version 4.05 22/09/2022");
  ...
  tft.println("SI4735/32 DSP Radio");
  tft.setCursor(7, 70);
  tft.println(" Version 4.05");
  tft.setCursor(7, 95);
  tft.println(" 22/09/2022");
  ...
  if ( si4735Addr == 0 ) {
    ...
    tft.print("Si4735/32 not detected");
    Serial.println("Si4735/32 not detected");
    while (1);
  } else {
    tft.setTextColor(TFT_GREEN, TFT_BLACK);
...
void brightnessIndicator(int val) {
  ...
  tft.fillRect(XVolInd + 17 + val, YVolInd + 16 , 130 - (2 + val), 6, TFT_BLACK);
}
...
void subrstatus() {
  ...
  tft.setCursor(0, 0);
  tft.setTextColor(TFT_YELLOW, TFT_BLACK);
  tft.drawString("Software V4.05 22/09/2022 QEX Team MOD", 5, 0);
